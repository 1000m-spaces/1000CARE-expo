...
import { searchProductsV2, resetSearchProductsV2 } from '~/store/catalogV2/catalogV2Actions';
...
// Màn KẾT QUẢ tìm kiếm (2026-09-18, theo mẫu Shopee: màn gõ/gợi ý
...
const SearchResultsV2 = ({ navigation, route }) => {
  ...
  useEffect(() => {
    if (route?.params?.keyword) {
      dispatch(searchProductsV2(route.params.keyword, 30, 0));
    }
    return () => {
      ...
      <View style={styles.headerRow}>
        ...
        <View style={styles.searchDock}>
          ...
          <TextInput
            ...
            autoFocus={!route?.params?.keyword}
          />
          {!!query && (
